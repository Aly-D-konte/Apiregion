...
public class ApiRegionsApplication {
	...
	return args -> {
		...
		accountServices.addNewUsers(new UsersApp(null, "aly","alykonte19@gmail.com","1234",new ArrayList<>()));
		...
		accountServices.addRoleToUser("aly","ADMIN");
		accountServices.addRoleToUser("adama","USER");
